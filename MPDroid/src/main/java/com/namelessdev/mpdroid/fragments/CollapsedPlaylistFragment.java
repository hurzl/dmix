...
public class CollapsedPlaylistFragment extends QueueFragment implements OnMenuItemClickListener {
                            ...
                            public void run() {
                                try {
                                    mApp.oMPDAsyncHelper.oMPD.getPlaylist()
                                            .removeById(Tools.toIntArray(positions));
    ...
    public boolean onMenuItemClick(final MenuItem item) {
        ...
        if (plAlbum == null || plAlbum.isPlaying()) {
    ...
    public void scrollToNowPlaying() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(final Void... voids) {
                songPos = getListPosition(mApp.oMPDAsyncHelper.oMPD.getStatus().getSongPos());
                return null;
            }
            ...
            protected void onPostExecute(final Void result) {
                ...
                if (songPos == -1) {
                    Log.d("MPD", "CollapsedPlaylistFragment: Missing list item.");
                } else {
    ...
    public void trackChanged(final MPDStatus mpdStatus, final int oldTrack) {
        if (mSongList != null) {
            ...
            super.trackChanged(mpdStatus, oldTrack);
        }
    }
